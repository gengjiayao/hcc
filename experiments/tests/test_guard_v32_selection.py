...
from experiments.select_guard_v32_ack_slack_window import PERCENT_GATES, select


class GuardV32SelectionTests(unittest.TestCase):
    ...
    def campaign(self, root, long_high=-0.5):
        ...
        spec = {"mechanism_profile": "V32", "name": "v32",
