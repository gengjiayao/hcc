...
from experiments.select_guard_v26_elephant_receiver_authority import select


class GuardV26SelectionTests(unittest.TestCase):
    ...
    def campaign(self, root, long_high=-6.0):
        spec = {
            "mechanism_profile": "V26", "name": "v26",
            "seeds": [200, 201, 202, 203, 204],
            "arms": {"guard_k1": {}, "guard_elephant_authority": {}},
            "selection": {
        ...
        self.write_json(root / "summary/general_report.json", {
            "performance": {"AliStorage50": {"paired": {
                "guard_elephant_authority_minus_guard_k1": metrics}}}})
    ...
    def test_selects_only_after_all_frozen_gates_pass(self):
        with tempfile.TemporaryDirectory() as directory:
            ...
            self.assertEqual(result["selected_arm"], "guard_elephant_authority")
