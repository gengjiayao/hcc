#!/usr/bin/env python3
"""Fail-closed, mechanism-only analysis for the GUARD V16 campaign."""
...
try:
    ...
    from experiments.run_guard_v16_compatibility import read_spec
    ...
    from run_guard_v16_compatibility import read_spec
