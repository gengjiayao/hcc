#!/usr/bin/env python3
"""Fail-closed, mechanism-only analysis for the GUARD V17 campaign."""
...
try:
    ...
    from experiments.run_guard_v17_compatibility import read_spec
    ...
    from run_guard_v17_compatibility import read_spec
